...
ggsave("pFig1_Multispecies_AllPassSummary_Merge_Heat_grey95_blackfill.tiff", width=240, height=275, units="mm")
...
And together:
```{r}
(pCompeteDeltaGrowth_byORI+pCompeteDeltaGrowth_byALT + plot_layout(axis_titles = "collect"))/
  (pCompeteDeltaCFU_byORI+pCompeteDeltaCFU_byALT + plot_layout(axis_titles = "collect")) + 
...
NRRL2_CG_Morph_Compete_d14_s<- NRRL2_CG_Morph_Compete_d14 %>%
  dplyr::select(strain1, strain2, SamePair, fAlt)
```
...
```{r}
pairwise_betar<-betareg(fAlt ~ strain1 + strain2, data=NRRL2_CG_Morph_Compete_d14_s)
...
plot_grid(pCG_Compete_WormChunk_fEdge_slopes,
          ...
          ncol=1, labels="AUTO")
ggsave("FigS8_CG_Compete_WormChunk_slopes.png", width=8, height=6, units="in", dpi=400)
```
...
ggsave("Fig3_pCGMotilitySummary.tiff", width=228, height=182, units="mm")
...
pNutrientMotility
#ggsave("Fig4_NutrientMotility.png", width=8, height=12, units="in", dpi=400)
ggsave("Fig4_NutrientMotility.tiff", width=160, height=240, units="mm")
...
Then the rates:
```{r}
plot_grid(pLVparams_spline_r_box_nutrient + stat_compare_means(label.y.npc = c(0.28, 0.9, 1.1)), 
          p_diam_mumax, p_spread_mumax,
          ncol=1, labels="AUTO", rel_heights = c(1, 0.7, 0.7))
ggsave("FigS9_pDiameterRates.png", width=8, height=10, units="in", dpi=300)
```
...
plot_grid(pLVparams_spline_K_box_nutrient + stat_compare_means(label.y.npc = c(0.28, 0.6, 1.1)), 
          p_diam_K, p_spread_K,
          ncol=1, labels="AUTO", rel_heights=c(1, 0.7, 0.7))
ggsave("FigS10_pDiameterVsK.png", width=8, height=10, units="in", dpi=300)
```
