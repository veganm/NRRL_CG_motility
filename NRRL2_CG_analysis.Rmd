...
ggsave("pFig1_Multispecies_AllPassSummary_Merge_Heat_ivory1_grey80.tiff", width=240, height=275, units="mm")
...
plot_grid(pCompeteDeltaGrowth_byORI, pCompeteDeltaCFU_byORI,
          ...
          ncol=2, labels="AUTO")
ggsave("Figure S6_CompeteDeltas.png", width=10, height=8, units="in", dpi=300)
```
...
plot_grid(pCG_Compete_WormChunk_fEdge_slopes,
          ...
          ncol=1, labels="AUTO")
ggsave("FigS7_CG_Compete_WormChunk_slopes.png", width=8, height=6, units="in", dpi=400)
```
...
ggsave("Fig2_CG_Compete.tiff", width=336, height=168, units="mm")
