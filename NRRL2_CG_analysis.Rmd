...
ggsave("FigS8_pCGMotilitySummary.png", width=10, height=8, units="in", dpi=400)
#ggsave("FigS8_pCGMotilitySummary.tiff", width=228, height=152, units="mm")
...
#ggsave("Fig3_NutrientMotility.png", width=12, height=7, units="in", dpi=400)
ggsave("Fig3_NutrientMotility.tiff", width=240, height=180, units="mm")
